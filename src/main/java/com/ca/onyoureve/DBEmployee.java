...
public class DBEmployee
{
    ...
    {
       try {  Connection conn = ConnectDB.ConnectDb(sqlType);
            if (conn != null)
            {
                ...
                {                                                                   // reads a row
                    ...
                    Employee emp = new Employee(id, name, dob, phone, email, nid,  acc, wt, Integer.parseInt(wr), points, mid);
                    emp.display();
                }
            }
    ...
    public void insertEmployee() {
       ...
       try {  Connection conn = ConnectDB.ConnectDb(sqlType);
            if (conn != null) {
                ...
                query = "insert into employee(emp_id, name, dob, email, phone_no, nid, account_number, wage_type, wage_rate, points, mgr_id)" +
                        "values('" + emp.getEmployee_id() + "','" + emp.getName() + "'," + "STR_TO_DATE('" + emp.getDob() + "','%d/%m/%y')" + ",'" + emp.getEmail() +
                        "','" + emp.getPhone_no() + "','" + emp.getnid() + "','" + emp.getAccount_number() + "','" + emp.getWage_type() + "'," +
    ...
    public void insertEmployee(Employee emp, String id) {
       ...
       try {  Connection conn = ConnectDB.ConnectDb(sqlType);
            if (conn != null) {
                ...
                String query ="insert into employee(emp_id, name, dob, email, phone_no, nid, account_number, wage_type, wage_rate, points, mgr_id)" +
                        "values('" + emp.getEmployee_id() + "','" + emp.getName() + "'," + "STR_TO_DATE('" + emp.getDob() + "','%d/%m/%y')" + ",'" + emp.getEmail() +
                        "','" + emp.getPhone_no() + "','" + emp.getnid() + "','" + emp.getAccount_number() + "','" + emp.getWage_type() + "'," +
                        Integer.toString(emp.getWage_rate()) + "," + Integer.toString(emp.getPoints()) + ",'" + emp.getMgr_id() + "')";
...
//                String query = "select * from EMPLOYEEPASS" ;   // query to be sent
